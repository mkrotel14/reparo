...
const styles = StyleSheet.create((theme) => ({
  ...
  metricCard: { backgroundColor: theme.colors.surface, borderColor: theme.colors.border, borderRadius: theme.radius.lg, borderWidth: 1, padding: theme.spacing.xl },
  metricValue: { color: theme.colors.text, fontSize: 56, fontWeight: '800', lineHeight: 62 },
  metricLabel: { color: theme.colors.textMuted, fontSize: theme.typography.body, marginTop: theme.spacing.xs },
  metricDivider: { backgroundColor: theme.colors.border, height: 1, marginVertical: theme.spacing.lg },
  supportingMetrics: { flexDirection: 'row', gap: theme.spacing.lg },
  supportingMetric: { flex: 1, gap: theme.spacing.xs },
  supportingValue: { color: theme.colors.text, fontSize: theme.typography.heading, fontWeight: '800' },
  supportingLabel: { color: theme.colors.textMuted, fontSize: theme.typography.caption },
  section: { gap: theme.spacing.sm },
  sectionTitle: { color: theme.colors.text, fontSize: theme.typography.body, fontWeight: '800' },
  settingsCard: { backgroundColor: theme.colors.surface, borderColor: theme.colors.border, borderRadius: theme.radius.lg, borderWidth: 1 },
